...
//    private var networkRequester = Network()
    private var networkPromiseRequester = PromiseNetworkService()
    ...
    func fetchMyGroups() {
        //MARK: request with PromiseKit
        networkPromiseRequester.fetchGroupsToRealm()
        
        //MARK: request without PromiseKit
